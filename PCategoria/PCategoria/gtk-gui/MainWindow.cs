...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='addAction' action='addAction'/><toolitem name='refreshAction' action='refreshAction'/><toolitem name='deleteAction1' action='deleteAction1'/><toolitem name='editAction' action='editAction'/></toolbar></ui>");
