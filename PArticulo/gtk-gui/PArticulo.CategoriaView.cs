...
namespace PArticulo
{
	public partial class CategoriaView
	{
		...
		protected virtual void Build ()
		{
			...
			this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='saveAction' action='saveAction'/><toolitem name='addAction1' action='addAction1'/></toolbar></ui>");
